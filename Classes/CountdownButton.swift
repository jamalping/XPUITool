...
/// 记录倒计时开始的时间
public var countdown_time: TimeInterval = 0
/*
...
//    var tapClick: ((UIButton)->Void)?
    ...
    /// 倒计时时间
    public var countdownTime: TimeInterval = 60
    
    /// 是否需要倒计时，默认true
    public var isCountDown = true
    ...
    /// 倒计时时间，是否需要倒计时
    public convenience init(countdownTime: TimeInterval = 60, isCountdown: Bool = true) {
        self.init()
