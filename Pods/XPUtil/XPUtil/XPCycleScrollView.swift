...
import UIKit
class XYJCycleScrollView: UIView {
...
//    var indexTap = Variable<(String?, String?)>.init((nil, nil))
    ...
    init(animationTimerInterval: TimeInterval = 5.0){
    ...
    func setDataSource(_ datas: [String]) {
...
extension XYJCycleScrollView: UIScrollViewDelegate {
